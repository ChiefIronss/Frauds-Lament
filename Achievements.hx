...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["This Is Just The Beginning...",	"Beat Desolation.",								'deso_complete',		false],
		["Hallucuniogenic Gasses",		"Beat Impostor Syndrome.",							'impsyn_complete',		false],
		["I'll See You In Update 2!",	"Beat the Main Game.",								'mauso_complete',		 true],
		["The Fear Of Being Chased",	"Beat Diokophobia.",								'dioko_complete',		 true],
		["The Fear Of Lightning",		"Beat Astraphobia.",								'astra_complete',		 true],
